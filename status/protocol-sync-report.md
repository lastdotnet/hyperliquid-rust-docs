...
- `docs/obsidian/ABCI State Machine.md:64` — The `Exchange` struct is the god object ("struct Exchange with 57 elements" in binary). Uses **full field names** in serde (NOT 2-char codes). See [[Exchange State]] for complete 57-field map. Key field categories:
- `crates/hl-engine/src/bootstrap_fast.rs:200` — // Exchange has 57 fields (binary: "struct Exchange with 57 elements").
